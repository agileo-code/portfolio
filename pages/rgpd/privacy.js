  ...
  return (
    <>
      ...
      <div className="bg-black text-white p-10">
        <h1 className="mt-10">POLÍTICA DE PRIVACIDAD</h1>
        <p>
          El presente Política de Privacidad establece los términos en que
          Nimbel usa y protege la información que es proporcionada por sus
        ...
        <h3 className="mt-10">Información que es recogida</h3>
        <p>
        ...
        <h3 className="mt-10">Uso de la información recogida</h3>
        <p>
        ...
        <h3 className="mt-10">Enlaces a Terceros</h3>
        <p>
        ...
        <h3 className="mt-10">Control de su información personal</h3>
        <p>
          n cualquier momento usted puede restringir la recopilación o el uso de
          ...
          que sea requerido por un juez con un orden judicial. Nimbel Se reserva
