const technologies = {
  ...
  gatsby: {
    name: 'Gatsby',
    icon: '/images/technologies/gatsby.svg'
  },
  firebase: {
  ...
  styledComponent: {
    ...
    icon: '/images/technologies/styled-component.png'
  },
  jitsi: {
    name: 'Jitsi Meet',
    icon: '/images/technologies/jitsi.png'
  },
  heroku: {
    name: 'Heroku',
  ...
  socketIo: {
    name: 'Socket IO',
    icon: '/images/technologies/socket-io.svg'
  },
  aws: {
  ...
  vercel: {
    name: 'Vercel',
    icon: '/images/technologies/vercel.png'
  }
};
